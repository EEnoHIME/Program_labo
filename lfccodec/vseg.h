...
#define NUM_OF_VGEN 1.0 //(NUM_OF_VGEN > 0)
#define NUM_OF_VGENc 1.0//(NUM_OF_VGENc=<NUM_OF_VGEN) && (NUM_OF_VGENc>0)
...
#define MERGE_CENTERy 1.0
#define MERGE_CENTERx 1.0
#define MERGE_EDGEy 1.0
#define MERGE_EDGEx 1.0
